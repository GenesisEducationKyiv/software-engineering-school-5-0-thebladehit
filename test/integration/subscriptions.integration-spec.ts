...
import { AppModule } from '../../apps/subscriptions/src/app.module';
...
import { PrismaService } from '../../apps/subscriptions/src/modules/prisma/prisma.service';
...
describe('Subscriptions endpoints (Integration tests)', () => {
  ...
  beforeEach(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      .overrideProvider(AbstractNotificationsService)
